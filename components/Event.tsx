...
const Event = () => {
  return (
    <div className="hero group  min-h-screen w-screen flex flex-wrap bg-base-200 justify-center">
      <div className="hero-content flex-col lg:flex-row">
        <div className=" flex justify-center items-center flex-col w-full">
          <h1 className="text-6xl font-bold group-hover:animate-[fade-in-down_2s_ease-in-out]">
            Tech <span className=" text-secondary">Witz</span>
          </h1>
          <p className="py-6 group-hover:animate-[fade-in-left_2s_ease-in-out]">
        ...
        <div className=" rounded-md absolute bg-neutral w-full h-full bg-opacity-80"></div>
          ...
          <div
          className=" relative w-56 bg-cover h-24  rounded-md text-center flex justify-center items-center m-2 cursor-pointer group-hover:animate-[fade-in_2s_ease-in-out]" style={{backgroundImage: 'url(https://media.tenor.com/gfpuxIwUd8UAAAAC/the-doctor-leo-fitz.gif)'}}>
        <div className=" rounded-md absolute bg-neutral w-full h-full bg-opacity-80"></div>
            <h1
            className=" z-10 inline-block text-center text-2xl hover:text-3xl duration-300 font-bold hover:text-primary">
               Dev Geeks 
