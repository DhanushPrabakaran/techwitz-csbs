  ...
  return (
    <div className="hero group min-h-screen bg-base-200">
      <div className="hero-content text-center">
        <div>
          <h1 className="text-3xl max-md:text-2xl font-bold m-2 animate-[fade-in-down_2s_ease-in-out] text-secondary">{"<<"}Staff Coordinator{">>"}</h1>
          <div className="flex flex-wrap w-full justify-center">
            ...
            <div
              className="m-2 items-center flex flex-col">
                ...
                <h2 className=" font-bold  text-secondary animate-[fade-in-left_2s_ease-in-out]">Assistant professor, CSBS</h2>
              ...
              className="m-2 items-center flex flex-col">
                <Image
                  ...
                  alt="picture"
                />
                <h2 className=" font-bold text-xl text-primary animate-[fade-in_2s_ease-in-out] ">Mr. P. Mathivanan</h2>
                <h2 className=" font-bold  text-secondary animate-[fade-in_2s_ease-in-out] ">Assistant professor, CSBS</h2>
                {/* <div>icons</div> */}
              </div>
              <div
              className="m-2 items-center flex flex-col">
                <Image
                  ...
                  alt="picture"
                />
                <h2 className=" font-bold text-xl text-primary animate-[fade-in-right_2s_ease-in-out] ">Mrs. Sujaya</h2>
                <h2 className=" font-bold  text-secondary animate-[fade-in-right_2s_ease-in-out] ">Assistant professor, CSBS</h2>
